...
const Feedback = () => {
    ...
    return (
    <div style={{textAlign:"center", color:"#232323", border:"black 10px solid", backgroundImage:`url(${hobbiesBg})`, backgroundSize: 'cover', backgroundPosition: 'center', backgroundAttachment: 'fixed', backgroundRepeat: 'no-repeat'}}>
